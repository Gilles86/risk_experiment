...
python $HOME/git/risk_experiment/risk_experiment/encoding_model/fit_task_cv.py $PARTICIPANT_LABEL 7t2 --bids_folder /scratch/gdehol/ds-risk --smoothed --denoise --retroicor
