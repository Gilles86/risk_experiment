...
def main(model_label, session, burnin=1000, samples=1000, bids_folder='/data/ds-risk', n_cores=4):
...
def build_model(model_label, df, session=None, bids_folder='/data/ds-risk'):
    ...
    elif model_label.startswith('probit_neural1'):
...
if __name__ == '__main__':
    ...
    main(args.model_label, args.session, bids_folder=args.bids_folder, n_cores=args.n_cores)
