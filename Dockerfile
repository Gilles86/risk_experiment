...
RUN printf '{ \
  ...
  "instructions": [ \
    ...
    { \
      "name": "run", \
      "kwds": { \
        "command": "bash -c 'source activate neuro && cd /braincoder && python setup.py develop --no-deps'" \
      } \
    }, \
    { \
      "name": "copy", \
    ...
    { \
      "name": "run", \
      "kwds": { \
        "command": "bash -c 'source activate neuro && cd / && python setup.py develop --no-deps'" \
      } \
    }, \
    { \
      "name": "copy", \
      "kwds": { \
        ...
        "destination": "/root/.nipype/nipype.cfg" \
      } \
    }, \
    { \
      "name": "copy", \
